 ...
 */
public class
MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, GetMainPresenter.mainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedUser.compareTo(Cache.getInstance().getCurrUser()) == 0) {
            ...
            presenter.isFollowerTask(selectedUser);
    ...
    public void onStatusPosted(String post) {
        ...
        try {
            ...
            presenter.postStatusTask(newStatus);
        } catch (Exception ex) {
    ...
    @Override
    public void runActivity(User user) {

    }


    @Override
    public void setFollowingButton(boolean status) {
        if (status){
            followButton.setText(R.string.following);
            followButton.setBackgroundColor(getResources().getColor(R.color.white));
            followButton.setTextColor(getResources().getColor(R.color.lightGray));
    ...
    @Override
    public void updateUsers(boolean status) {
        updateSelectedUserFollowingAndFollowers();
        updateFollowButton(status);
    }

    @Override
    public void followButtonReset() {
