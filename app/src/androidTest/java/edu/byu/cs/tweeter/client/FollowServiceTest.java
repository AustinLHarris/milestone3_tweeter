...
//import edu.byu.cs.tweeter.client.model.service_new.FollowService;
...
public class FollowServiceTest {
    ...
    /**
     * Verify that for successful requests, the {@link FollowService#loadMoreFollowing(User, int, User, PagedNotificationObserver)}
    ...
    public void testGetFollowees_validRequest_correctResponse() throws InterruptedException {
        followServiceSpy.loadMoreFollowing(currentUser, 3, null, observer);
        awaitCountDownLatch();
    ...
    /**
     * Verify that for successful requests, the the {@link FollowService#loadMoreFollowing(User, int, User, PagedNotificationObserver)}
    ...
    /**
     * Verify that for unsuccessful requests, the the {@link FollowService#loadMoreFollowing(User, int, User, PagedNotificationObserver)}
    ...
    public void testGetFollowees_invalidRequest_returnsNoFollowees() throws InterruptedException {
        followServiceSpy.loadMoreFollowing(null, 0, null, observer);
        awaitCountDownLatch();
